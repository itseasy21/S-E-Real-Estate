...
public class Employee extends User{
    ...
    EmployeeType empRole = EmployeeType.BranchAdmin;
    double salary = 0;
    double workingHours = 0;

    public Employee(String email, String password, String name, String address, String phoneNo, String dob, String gender, EmployeeType empType, EmployeeType empRole, double salary, double workingHours) {
